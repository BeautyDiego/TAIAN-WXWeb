	...
	<div>
		...
		<div style="padding:1rem 1rem 0">
			<flexbox>
				...
				<flexbox-item >
					<x-button style="background-color:#e59313;color:#fff"  @click.native="validateStudent">验证</x-button>
				</flexbox-item>
			</flexbox>
...
<script>
    ...
    import {validateStu,forgetPwd} from './../getData/getData'
    export default {
        components: {
            Cell,
            Group,
        ...
        methods: {
            async validateStudent(){
                if (this.validateForm.id_card&&this.validateForm.name&&this.validateForm.mobile){
                    ...
                    let res= await validateStu(params);
                    if (res.success){
