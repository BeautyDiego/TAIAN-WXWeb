<template>
	<div style="height:100%;">
		...
		<tabbar class="headmaster-tabbar"  style="position:fixed" v-model="tabIndex">
			<tabbar-item link="/teachplan" >
				<span class="demo-icon-22" slot="icon">&#xe604;</span>
				<span slot="label">教学计划</span>
			</tabbar-item>
			<tabbar-item link="/reservationdetails" >
				<span class="demo-icon-22" slot="icon">&#xe63e;</span>
...
<style lang="less">
	...
	@font-face {
		font-family: 'iconfont';  /* project id 465338 */
		src: url('//at.alicdn.com/t/font_465338_bkagv20atomeu3di.eot');
		src: url('//at.alicdn.com/t/font_465338_bkagv20atomeu3di.eot?#iefix') format('embedded-opentype'),
		url('//at.alicdn.com/t/font_465338_bkagv20atomeu3di.woff') format('woff'),
		url('//at.alicdn.com/t/font_465338_bkagv20atomeu3di.ttf') format('truetype'),
		url('//at.alicdn.com/t/font_465338_bkagv20atomeu3di.svg#iconfont') format('svg');
	}
