<template>
	<div v-if="isBinded" class="login-page">
		<div  style="text-align: center">
			<img src="./../../../assets/img/coachlogin.jpg" >
		</div>
		<box gap="20px 20px">
...
<style lang="less">
	...
	@font-face {
		...
		src: url('//at.alicdn.com/t/font_465338_7w0tsxe111exw29.eot');
		src: url('//at.alicdn.com/t/font_465338_7w0tsxe111exw29.eot?#iefix') format('embedded-opentype'),
		url('//at.alicdn.com/t/font_465338_7w0tsxe111exw29.woff') format('woff'),
		url('//at.alicdn.com/t/font_465338_7w0tsxe111exw29.ttf') format('truetype'),
		url('//at.alicdn.com/t/font_465338_7w0tsxe111exw29.svg#iconfont') format('svg');
	}
